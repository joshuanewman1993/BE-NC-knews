...
exports.formatArticle = articles => articles.map(({ created_by, created_at, ...articles }) => ({
  username: created_by,
  created_at: timeConverter(created_at),
  ...articles,
}));

exports.formatComments = (comments, article) => comments.map(({
  belongs_to, created_by, created_at, ...comments
}) => {
